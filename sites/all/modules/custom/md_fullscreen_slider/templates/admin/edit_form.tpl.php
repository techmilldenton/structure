    ...
    <div class="mdf-tabs-tool">
      ...
      <div class="mdf-setting" id="mdf-setting-dlg" style="display: none;">
        <div class="mdf-setting-aside">
          ...
          <div class="row row-background-overlay">
            <input type="hidden" value="" autocomplete="off"/>
            <label class="lb-color">Backgroud Overlay</label>
          </div>
        ...
        <div id="tabs-<?php print $slide->position; ?>" class="tabs-panel"
          ...
          <div class="mdf-slidewrap mdf-fullwidth">
            ...
            <?php if (isset($slide->settings['bgOverlay']) && $slide->settings['bgOverlay'] != ''): ?>
              <div class="mdf-slide-overlay" style="background-color: <?php print $slide->settings['bgOverlay']; ?>"></div>
            <?php else: ?>
              <div class="mdf-slide-overlay"></div>
            <?php endif; ?>
