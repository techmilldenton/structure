...
(function (window, $, undefined) {
    ...
    function spectrum(element, o) {
        ...
        function applyOptions() {
            ...
            alphaSlider.toggleClass("verticle", opts.AlphaVerticle);
            ...
            // Custom AlphaVerticle
            if(opts.AlphaVerticle)
                flagAlphaVerticle = true;
            //
            reflow();
        }
        ...
        function updateHelperLocations() {
            ...
            if(allowEmpty && isEmpty) {
                ...
                if(!flagAlphaVerticle){
                    ...
                    alphaSlideHelper.css({
                        "bottom": (alphaY - (alphaSlideHelperHeight / 2)) + "px"
                    });
                }
                //
