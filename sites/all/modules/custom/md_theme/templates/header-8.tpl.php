<?php
	...
	$path = base_path() . drupal_get_path("theme","md_structure") . "/logo-white.png";
...
?>
<div class="header-wrapper scheme header-preset-02 full-bg">
	<div class="top-area">
    	<div class="container">
        	<div class="row">
            	<div class="col-md-9">
                  ...
                  <aside class="widget widget_text">
                      <div class="textwidget">
                          <div class="row extra-info">
                              <?php
								  $block = module_invoke('bean', 'block_view', 'header-info');
								  print render($block['content']);
							  ?>
                          </div>
                      </div>
